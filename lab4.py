...
subscription_id = os.environ["AZURE_SUBSCRIPTION_ID"] = "b661ad7f-674a-4867-9414-dfa23edbcfab"
...
VNET_NAME = "net4-python"
SUBNET_NAME = "snet4-python"
IP_NAME = "ip4-python"
IP_CONFIG_NAME = "ip-config4-python"
NIC_NAME = "nic4-python"

# Get the management object for the network
network_client = NetworkManagementClient(credential, subscription_id)

# Create the virtual network
poller = network_client.virtual_networks.begin_create_or_update(RESOURCE_GROUP,
    VNET_NAME,
    {
        "location": LOCATION,
        "address_space": {
...
# 3 - Create the subnet
poller = network_client.subnets.begin_create_or_update(RESOURCE_GROUP,
...
poller = network_client.public_ip_addresses.begin_create_or_update(RESOURCE_GROUP,
    IP_NAME,
    {
        "location": LOCATION,
        "sku": { "name": "Standard" },
...
poller = network_client.network_interfaces.begin_create_or_update(RESOURCE_GROUP,
    NIC_NAME,
    {
        "location": LOCATION,
        "ip_configurations": [ {
